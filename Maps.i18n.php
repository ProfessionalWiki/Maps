...
$1',
	...
	'maps_error_accepts_only' => 'Parameter $1 only accepts {{PLURAL:$2|this value|these values}}: $2.',
...
$1',
	...
	'maps_error_parameters' => 'У сынтаксісе выяўлены наступныя памылкі',
	'maps_error_invalid_argument' => 'Значэньне $1 не зьяўляецца слушным для парамэтру $2.',
	'maps_error_empty_argument' => 'Парамэтар $1 ня можа мець пустое значэньне.',
	'maps_error_required_missing' => 'Не пададзены абавязковы парамэтар $1.',
	'maps_error_must_be_number' => 'Парамэтар $1 можа быць толькі лікам.',
	'maps_error_ivalid_range' => 'Парамэтар $1 павінен быць паміж $2 і $3.',
	'maps_overlays' => 'Слаі',
...
K dispoziciji stojece kórtowe słužby: $1',
	...
	'maps_error_unknown_argument' => '$1 njejo płaśiwy parameter.',
	...
	'maps_error_accepts_only' => 'Parameter $1 móžo jano $2 byś.',
...
$1",
	...
	'maps_error_unknown_argument' => '$1 n’est pas un paramètre valide.',
	...
	'maps_error_accepts_only' => 'Le paramètre $1 ne peut être que $2.',
...
$1',
	...
	'maps_error_unknown_argument' => '"$1" non é un parámetro válido.',
	...
	'maps_error_accepts_only' => 'O parámetro "$1" só pode ser "$2".',
...
K dispoziciji stejace kartowe słužby: $1',
	...
	'maps_error_unknown_argument' => '$1 płaćiwy parameter njeje.',
	...
	'maps_error_accepts_only' => 'Parameter $1 móže jenož $2 być.',
...
$1',
	...
	'maps_error_unknown_argument' => '$1 は有効な引数ではありません。',
	...
	'maps_error_accepts_only' => '引数 $1 は $2 にのみなることができます。',
...
$1.',
	...
	'maps_error_unknown_argument' => '$1 is geen geldige parameter.',
	...
	'maps_error_accepts_only' => 'De parameter $1 kan alleen "$2" zijn.',
	'maps_googlemaps' => 'Google Maps',
	'maps_yahoomaps' => 'Yahoo! Maps',
	'maps_openlayers' => 'OpenLayers',
...
$1',
	...
	'maps_error_parameters' => 'Följande fel har upptäckts i din syntax',
	'maps_error_invalid_argument' => 'Värdet $1 är inte giltigt som parameter $2.',
	'maps_error_empty_argument' => 'Parametern $1 kan inte lämnas tom.',
	'maps_error_required_missing' => 'Den nödvändiga parametern $1 har inte angivits.',
	'maps_error_must_be_number' => 'Parameter $1 måste bestå av ett tal.',
