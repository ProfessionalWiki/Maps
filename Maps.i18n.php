...
$messages['br'] = array(
	...
	'validation-error-invalid-location' => "Ret eo d'an arventenn $1 bezañ evit ul lec'hiadur reizh.",
	'validation-error-invalid-width' => "Ret eo d'an arventenn $1 bezañ evit ul ledander reizh.",
	'validation-error-invalid-height' => "Ret eo d'an arventenn $1 bezañ evit un uhelder reizh.",
	'maps-abb-north' => 'N',
	'maps-abb-east' => 'R',
	'maps-abb-south' => 'S',
	'maps-abb-west' => 'K',
...
$1",
	...
	'validation-error-invalid-distance' => "An talvoud $1 n'eo ket un hed reizh anezhañ.",
...
Dostupne usluge mapa: $1',
	...
	'validation-error-invalid-locations-omitted' => 'Parametar $1 mora biti jedna ili više valjanih lokacija. {{PLURAL:$3|Vrijednost|Vrijednosti}} "$2" {{PLURAL:$3|je|su}} ispuštene.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Vrijednost $1 nije ispravno odstojanje.',
...
Verfügbare Kartografie-Dienste: $1',
	...
	'validation-error-invalid-locations-omitted' => 'Parameter $1 muss einem oder mehreren gültigen Standorten entsprechen. {{PLURAL:$3|Der Wert|Die Werte}} „$2“ {{PLURAL:$3|wurde|wurden}} nicht berücksichtigt.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Der Wert $1 ist keine gültige Distanz.',
...
$messages['gsw'] = array(
	...
	'validation-error-invalid-locations-omitted' => 'Parameter $1 mueß ei oder meh giltigi Standort syy. {{PLURAL:$3|Dr Wärt|D Wärt}} „$2“ {{PLURAL:$3|isch|sin}} nit berucksichtigt wore.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Dr Wärt $1 isch kei giltige Abstand.',
...
Servicios cartographic disponibile: $1',
	...
	'validation-error-invalid-locations-omitted' => 'Le parametro $1 debe esser un o plus locos valide. Le {{PLURAL:$3|valor|valores}} "$2" ha essite omittite.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Le valor $1 non es un distantia valide.',
...
Картографски служби на располагање: $1',
	...
	'validation-error-invalid-locations-omitted' => 'Параметарот $1 мора да претставува една или повеќе важечки местоположби. Тука {{PLURAL:$3|е изоставена|се изоставени}} {{PLURAL:$3|вредноста|вредностите}} „$2“.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Вредноста $1 не претставува важечко растојание.',
...
Beschikbare kaartdiensten: $1',
	...
	'validation-error-invalid-locations-omitted' => 'Parameter $1 moet een of meer geldige locaties zijn. De {{PLURAL:$3|waarde|waarden}} "$2" {{PLURAL:$3|ontbreekt|ontbreken}}.',
...
$1.',
	...
	'validation-error-invalid-distance' => 'De waarde $1 is geen geldige afstand.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Wartość $1 nie jest poprawną odległością.',
...
$1",
	...
	'validation-error-invalid-distance' => "Ël valor $1 a l'é pa na distansa bon-a.",
...
Serviços de cartografia disponíveis: $1',
	...
	'validation-error-invalid-locations-omitted' => 'O parâmetro $1 tem de ser uma ou mais localizações válidas. {{PLURAL:$3|O valor|Os valores}} "$2" {{PLURAL:$3|foi omitido|foram omitidos}}.',
...
$1',
	...
	'validation-error-invalid-distance' => 'O valor $1 não é uma distância válida.',
...
Serviços de mapeamento disponíveis: $1',
	...
	'validation-error-invalid-locations-omitted' => 'O parâmetro $1 deve ser uma ou mais localizações válidas. {{PLURAL:$3|O valor|Os valores}} "$2" {{PLURAL:$3|foi omitido|foram omitidos}}.',
...
Доступные картографические службы: $1',
	...
	'validation-error-invalid-locations-omitted' => 'Параметр $1 должен содержать одно или несколько корректных местоположений. {{PLURAL:$3|Значение|значения}} «$2» {{PLURAL:$3|было пропущено|были пропущены}}.',
...
$1',
	...
	'validation-error-invalid-distance' => 'Значение $1 не является допустимым расстоянием.',
...
$1',
	...
	'maps_invalid_distance' => 'Giá trị $1 không phải là tầm hợp lệ.',
