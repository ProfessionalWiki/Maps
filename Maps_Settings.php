...
$GLOBALS['egMapsOLLayerDependencies'] = array(
	'yahoo' => "<style type='text/css'> #controls {width: 512px;}</style><script src='https://api.maps.yahoo.com/ajaxymap?v=3.0&appid=euzuro-openlayers'></script>",
	'bing' => "<script type='text/javascript' src='http://dev.virtualearth.net/mapcontrol/mapcontrol.ashx?v=6.1'></script>",
	'ol-wms' => "<script type='text/javascript' src='http://clients.multimap.com/API/maps/1.1/metacarta_04'></script>",
	'google' => "<script src='https://maps.google.com/maps/api/js?sensor=false'></script>",
);
